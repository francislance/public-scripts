...
usage() {
  cat <<'USAGE'
Usage:
  ./cluster-capacity.sh [--cpu <value>] [--memory <value>] [--buffer-percent <0-99>]

Examples:
  ./cluster-capacity.sh
  ./cluster-capacity.sh --cpu 4 --memory 8Gi
  ./cluster-capacity.sh --cpu 1500m --memory 2048Mi --buffer-percent 10
